...
/**
 * Provides parent product data when viewing product variation in the administration panel.
 *
 * @param array  $product   Variation product data
 * @param array  $auth      Authentication data
 * @param string $lang_code Two-letter language code
 *
 * @return array Parent product data
 */
function fn_product_variations_get_parent_product_data($product, $auth, $lang_code = CART_LANGUAGE)
{
    ...
    /**
     * Executes when fetching parent product data when viewing product variation in the administration panel,
     * allows to change parameters that will be passed to the product data obtaining function.
     *
     * @param array  $product                Variation product data
     * @param array  $auth                   Authentication data
     * @param string $lang_code              Two-letter language code
     * @param int    $parent_product_id      Configurable product ID
     ...
     * @param bool   $skip_company_condition Skip company condition and simply retrieve product data
     */
    fn_set_hook(
