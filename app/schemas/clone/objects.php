...
include_once(Registry::get('config.dir.schemas') . 'clone/objects.functions.php');

return array(
    'layouts' => array(
        'checked_by_default' => true,
        'function' => 'fn_clone_layouts',
        'post_handlers' => array('fn_ult_clone_post_handler_layouts')
    ),
    'settings' => array(
        'checked_by_default' => true,
        'tables' => array(
    ...
    'static_data_clone' => array(
        ...
        'post_handlers' => array('fn_ult_clone_post_handler_static_data')
    ),
    'categories' => array(
        'tables' => array(
            array(
