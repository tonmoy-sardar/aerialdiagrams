...
define('PRODUCT_VERSION', '4.9.2.SP1');
...
$config['resources'] = array(
    'docs_url'                      => 'https://docs.cs-cart.com/4.9.x/',
    'knowledge_base'                => 'http://docs.cs-cart.com/4.9.x/install/index.html',
    ...
    'admin_protection_url'          => 'http://docs.cs-cart.com/4.9.x/install/security.html#step-1-rename-admin-php',
    'widget_mode_url'               => 'http://docs.cs-cart.com/4.9.x/user_guide/look_and_feel/layouts/widget_mode/index.html',
    ...
    'kb_https_failed_url'           => 'http://docs.cs-cart.com/4.9.x/install/possible_issues/secure_connection_failed.html',
    ...
    'docs_guideline'                => 'http://docs.cs-cart.com/4.9.x/developer_guide/getting_started/guidelines.html',
    'translate'                     => 'http://translate.cs-cart.com',
);
