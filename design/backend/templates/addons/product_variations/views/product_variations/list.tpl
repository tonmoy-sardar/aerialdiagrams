<div id="content_variations">
    <div class="btn-toolbar clearfix">
        <div class="pull-left">
            {hook name="product_variations:list_default_variation"}
        ...
        <div class="pull-right">
            {hook name="product_variations:list_add_variations"}
            {include
        ...
        <table width="100%" class="table table-middle">
            <thead>
                <tr>
                    ...
                    {hook name="product_variations:list_header_list_price"}
                    <th width="15%">
            ...
            {foreach from=$products item=product}
                <tr class="cm-row-status-{$product.status|lower}">
                    ...
                    {hook name="product_variations:list_list_price"}
                    <td>
                    ...
                    <td class="nowrap">
                        <div class="hidden-tools">
                            {capture name="tools_list"}
                                {hook name="product_variations:list_tools_list"}
                    ...
                    <td class="right nowrap">
                        {include file="common/select_popup.tpl"
                            ...
                            table="products"
                            non_editable=($runtime.company_id && (fn_allowed_for("MULTIVENDOR") || $product.shared_product == "Y") && $product.company_id != $runtime.company_id)
                        }
                    </td>
                </tr>
            {/foreach}
