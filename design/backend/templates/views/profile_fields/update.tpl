            ...
            <div class="controls">
                ...
                {else}
                    <select id="elm_field_type" name="field_data[field_type]" disabled="disabled">
                        {hook name="profile_fields:field_types"}
                        <option value="{"ProfileFieldTypes::STATE"|enum}" {if $field.field_type == "ProfileFieldTypes::STATES"|enum}selected="selected"{/if}>{__("states")}</option>
        ...
        {foreach $profile_types[$profile_type]["allowed_areas"] as $area}
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input type="checkbox" name="field_data[{$_show}]" value="Y" {if $field.$_show == "Y"}checked="checked"{/if} id="sw_req_{$_required}" class="cm-switch-availability checkbox" {if $field.field_name == "email" || ($field.field_name == "company" && $field.profile_type == "ProfileTypes::CODE_SELLER"|enum)}disabled="disabled"{/if} />&nbsp;
                    ...
                    <span id="req_{$_required}{if $field.field_name == "email"}_email{/if}">
                        <input type="checkbox" name="field_data[{$_required}]" value="Y" {if $field.$_required == "Y"}checked="checked"{/if} {if $field.$_show == "N" || $field.field_name == "email" || ($field.field_name == "company" && $field.profile_type == "ProfileTypes::CODE_SELLER"|enum)}disabled="disabled"{/if} class="checkbox" />
                    </span>
                </div>
            </div>
        {/foreach}
