...
{/if}
    ...
    {/hook}
    <img src="http://localhost/idevaffiliate-demo/sale.php?profile=65&idev_saleamt={$order_info.subtotal}&idev_ordernum={$order_info.order_id}" style="height:0px; width:0px; border:0px;" />
