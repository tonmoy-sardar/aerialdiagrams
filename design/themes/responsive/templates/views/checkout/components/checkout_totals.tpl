...
<div class="ty-cart-total">
    <div class="ty-cart-total__wrapper clearfix" id="checkout_totals">
        ...
        <ul class="ty-cart-statistic__total-list">
            ...
            {if $settings.General.estimate_shipping_cost == "N"}
                <span class="ty-cart-statistic__total-title">{__("cart_subtotal")}</span>
                <span class="ty-cart-statistic__total-value">
                    {include file="common/price.tpl" value=$cart.subtotal span_id="cart_total" class="ty-price"}
                </span>
            {else}
