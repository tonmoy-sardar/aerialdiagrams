...
if (PHP_INT_SIZE == 4 && Bootstrap::getIniParam('memory_limit', Bootstrap::INI_PARAM_TYPE_BYTE) < 64 * 1024 * 1024) {
    // 32bit PHP
    @ini_set('memory_limit', '64M');
} elseif (PHP_INT_SIZE == 8 && Bootstrap::getIniParam('memory_limit', Bootstrap::INI_PARAM_TYPE_BYTE) < 256 * 1024 * 1024) {
    // 64bit PHP
