<?php /* Smarty version Smarty-3.1.21, created on 2018-12-20 12:05:25
         compiled from "C:\xampp\htdocs\cscart-demo\design\themes\aerialdiagrams\templates\addons\form_builder\hooks\pages\page_content.override.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14443170375c1b5b55befff0-87938129%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '174994dcc6de5f6e185930832e1993f8ee0fb9c4' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart-demo\\design\\themes\\aerialdiagrams\\templates\\addons\\form_builder\\hooks\\pages\\page_content.override.tpl',
      1 => 1544854013,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '14443170375c1b5b55befff0-87938129',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c1b5b55ce5fc7_30154126',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c1b5b55ce5fc7_30154126')) {function content_5c1b5b55ce5fc7_30154126($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\\block.hook.php';
if (!is_callable('smarty_modifier_in_array')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\\modifier.in_array.php';
...
if ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_PHONE')) {?> cm-phone<?php }?> <?php if ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_MULTIPLE_CB')) {?>cm-multiple-checkboxes<?php }?>"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['description'], ENT_QUOTES, 'UTF-8');?>
</label>
...
" />
                <?php }?>
                <input id="elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
" class="ty-input-text <?php if ($_smarty_tpl->tpl_vars['element']->value['position']==1) {?>cm-focus <?php }?>" size="50" type="text" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value], ENT_QUOTES, 'UTF-8');?>
" />
                
            <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_COUNTRIES')) {?>
                <?php $_smarty_tpl->tpl_vars['_country'] = new Smarty_variable((($tmp = @$_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['settings']->value['General']['default_country'] : $tmp), null, 0);?>
...
" <?php if ($_smarty_tpl->tpl_vars['_country']->value==$_smarty_tpl->tpl_vars['code']->value) {?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['country']->value, ENT_QUOTES, 'UTF-8');?>
            ...
            <?php } elseif ($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_STATES')) {?>
                ...
                <?php $_smarty_tpl->tpl_vars['_state'] = new Smarty_variable((($tmp = @$_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['settings']->value['General']['default_state'] : $tmp), null, 0);?>
