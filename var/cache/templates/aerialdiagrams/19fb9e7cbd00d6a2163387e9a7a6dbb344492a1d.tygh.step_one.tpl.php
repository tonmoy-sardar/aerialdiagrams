<?php /* Smarty version Smarty-3.1.21, created on 2018-12-20 12:52:22
         compiled from "C:\xampp\htdocs\cscart-demo\design\themes\aerialdiagrams\templates\views\checkout\components\steps\step_one.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11367352455c1b66562348b6-05616695%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '19fb9e7cbd00d6a2163387e9a7a6dbb344492a1d' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart-demo\\design\\themes\\aerialdiagrams\\templates\\views\\checkout\\components\\steps\\step_one.tpl',
      1 => 1544853072,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '11367352455c1b66562348b6-05616695',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c1b66562f7dc7_44540425',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c1b66562f7dc7_44540425')) {function content_5c1b66562f7dc7_44540425($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\\block.hook.php';
...
" method="post">
                    <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"checkout:user_register_form")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"checkout:user_register_form"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                    ...
                    <div class="checkout__block">
                        <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>$_smarty_tpl->__("register_new_account")), 0);?>
...
$_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"checkout:checkout_steps"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                    ...
                    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"checkout:user_register_form"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>

                    <div class="ty-checkout-buttons clearfix">
                        <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_meta'=>"ty-btn__secondary",'but_name'=>"dispatch[checkout.add_profile]",'but_text'=>$_smarty_tpl->__("register")), 0);?>

                        <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_onclick'=>"Tygh."."$"."('#step_one_register').hide(); Tygh."."$"."('#step_one_login').show();",'but_text'=>$_smarty_tpl->__("cancel"),'but_role'=>"text",'but_meta'=>"ty-checkout__register-cancel"), 0);?>
