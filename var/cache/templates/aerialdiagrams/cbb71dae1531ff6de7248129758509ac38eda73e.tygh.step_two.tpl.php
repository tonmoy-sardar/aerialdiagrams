<?php /* Smarty version Smarty-3.1.21, created on 2018-12-20 12:52:22
         compiled from "C:\xampp\htdocs\cscart-demo\design\themes\aerialdiagrams\templates\views\checkout\components\steps\step_two.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21177110745c1b6656899476-88232372%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cbb71dae1531ff6de7248129758509ac38eda73e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart-demo\\design\\themes\\aerialdiagrams\\templates\\views\\checkout\\components\\steps\\step_two.tpl',
      1 => 1544853072,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '21177110745c1b6656899476-88232372',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c1b66569490b3_05313397',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c1b66569490b3_05313397')) {function content_5c1b66569490b3_05313397($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\\block.hook.php';
...
" />
            ...
            <?php if ($_smarty_tpl->tpl_vars['edit']->value) {?>
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"checkout:edit_profile_fields")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"checkout:edit_profile_fields"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                ...
                <?php }?>
                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"checkout:edit_profile_fields"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                ...
                <?php } else { ?>
                    <div class="ty-checkout-buttons">
                        <?php if (!$_smarty_tpl->tpl_vars['complete']->value) {?>
                            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"checkout:step_two_button_components")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"checkout:step_two_button_components"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();
$_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"checkout:step_two_button_components"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>

                        <?php }?>

                        <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_meta'=>"ty-btn__secondary",'but_name'=>"dispatch[checkout.update_steps]",'but_text'=>$_smarty_tpl->__("continue")), 0);?>
