<?php /* Smarty version Smarty-3.1.21, created on 2018-12-20 13:14:34
         compiled from "C:\xampp\htdocs\cscart-demo\design\themes\aerialdiagrams\templates\views\checkout\components\checkout_totals.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18549058725c1b6b8a8fe7b7-78871309%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd1c4dd58cd2f66a0e212e4b524d547aeebf897f7' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart-demo\\design\\themes\\aerialdiagrams\\templates\\views\\checkout\\components\\checkout_totals.tpl',
      1 => 1544853072,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '18549058725c1b6b8a8fe7b7-78871309',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c1b6b8a931426_82269184',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c1b6b8a931426_82269184')) {function content_5c1b6b8a931426_82269184($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\\block.hook.php';
...
?><?php
fn_preload_lang_vars(array('change','calculate','calculate_shipping_cost','cart_subtotal','total_cost','change','calculate','calculate_shipping_cost','cart_subtotal','total_cost'));
?>
...
<div class="ty-cart-total">
    <div class="ty-cart-total__wrapper clearfix" id="checkout_totals">
        ...
        <ul class="ty-cart-statistic__total-list">
            ...
            <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['estimate_shipping_cost']=="N") {?>
                <span class="ty-cart-statistic__total-title"><?php echo $_smarty_tpl->__("cart_subtotal");?>
</span>
                <span class="ty-cart-statistic__total-value">
                    <?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['cart']->value['subtotal'],'span_id'=>"cart_total",'class'=>"ty-price"), 0);?>
