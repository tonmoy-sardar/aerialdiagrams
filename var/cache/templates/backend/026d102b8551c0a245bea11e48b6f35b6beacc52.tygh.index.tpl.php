<?php /* Smarty version Smarty-3.1.21, created on 2018-12-15 08:51:44
         compiled from "C:\xampp\htdocs\cscart-demo\design\backend\templates\views\index\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20737814725c14967023bdc0-23357105%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '026d102b8551c0a245bea11e48b6f35b6beacc52' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart-demo\\design\\backend\\templates\\views\\index\\index.tpl',
      1 => 1543374418,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '20737814725c14967023bdc0-23357105',
  'function' => 
  array (
    'get_orders' => 
    array (
  ...
  'unifunc' => 'content_5c149670312af3_86211780',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c149670312af3_86211780')) {function content_5c149670312af3_86211780($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\\function.script.php';
...
if (!is_callable('smarty_modifier_enum')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\\modifier.enum.php';
?><?php
fn_preload_lang_vars(array('previous_period','current_period','vendor_payouts.current_balance_text','vendor_payouts.income','orders','sales','taxes','users_carts','active_products','out_of_stock_products','registered_customers','categories','vendors','web_pages','order','by','no_data','statistics','recent_orders','order_by_status','status','qty','shipping','recent_activity','order','dashboard','installer_complete_title','welcome_screen.administrator_info','admin_panel','welcome_screen.go_admin_panel','welcome_screen.go_settings_wizard','settings_wizard','welcome_screen.run_settings_wizard','storefront','welcome_screen.go_storefront','welcome_screen.learn_more_configuration','welcome_screen.knowledge_base','welcome_screen.thanks'));
?>
...
"><?php echo htmlspecialchars(number_format($_smarty_tpl->tpl_vars['general_stats']->value['pages']['total_pages']), ENT_QUOTES, 'UTF-8');?>
    ...
    <?php if (!is_callable('smarty_modifier_date_format')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\modifier.date_format.php';
...
"><?php echo $_smarty_tpl->__('show_all');?>
                    ...
                    <?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\block.hook.php';
