<?php /* Smarty version Smarty-3.1.21, created on 2018-12-15 09:19:16
         compiled from "C:\xampp\htdocs\cscart-demo\design\backend\templates\views\addons\components\addons_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13903440135c149ce4e1d1d3-98779733%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2a2c04858df3eeed70a6dd470f638aa779bae209' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart-demo\\design\\backend\\templates\\views\\addons\\components\\addons_list.tpl',
      1 => 1543374418,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '13903440135c149ce4e1d1d3-98779733',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c149ce4e9e022_10595332',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c149ce4e9e022_10595332')) {function content_5c149ce4e9e022_10595332($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\\modifier.date_format.php';
?><?php
fn_preload_lang_vars(array('manage','settings','version','settings','licensing_and_upgrades','licensing_and_upgrades','uninstall','refresh','mve_plus_license_required','ultimate_license_required','install','installed','no_data'));
?>
...
<div class="table-responsive-wrapper">
    <table class="table table-addons cm-filter-table table-responsive table-responsive-w-titles" data-ca-input-id="elm_addon" data-ca-clear-id="elm_addon_clear" data-ca-empty-id="elm_addon_no_items<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix']->value, ENT_QUOTES, 'UTF-8');?>
">
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                ...
                <td width="15%" class="addon-action">
                    <?php if ($_smarty_tpl->tpl_vars['a']->value['status']=='N') {?>
                        ...
                        <div class="pull-right">
                            <a
                                class="btn lowercase cm-post <?php if ($_smarty_tpl->tpl_vars['a']->value['snapshot_correct']) {?>cm-ajax cm-ajax-full-render<?php } else { ?>cm-dialog-opener cm-dialog-auto-height<?php }?>"
                                <?php if ($_smarty_tpl->tpl_vars['a']->value['snapshot_correct']) {?>
...
"
                                ...
                                <?php } elseif (fn_allowed_for("MULTIVENDOR")) {?>
                                    <?php $_smarty_tpl->tpl_vars['promo_popup_title'] = new Smarty_variable($_smarty_tpl->__("mve_plus_license_required",array("[product]"=>@constant('PRODUCT_NAME'))), null, 0);?>

                                    href="<?php echo htmlspecialchars(fn_url("functionality_restrictions.mve_plus_license_required"), ENT_QUOTES, 'UTF-8');?>
"
...
$_smarty_tpl->tpl_vars['status_meta'] = new Smarty_variable('', null, 0);
                                ...
                                <?php echo $_smarty_tpl->getSubTemplate ("common/select_popup.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('popup_additional_class'=>"dropleft",'id'=>$_smarty_tpl->tpl_vars['key']->value,'status'=>$_smarty_tpl->tpl_vars['a']->value['status'],'st_return_url'=>rawurlencode($_smarty_tpl->tpl_vars['c_url']->value),'hide_for_vendor'=>$_smarty_tpl->tpl_vars['hide_for_vendor']->value,'non_editable'=>false,'status_meta'=>$_smarty_tpl->tpl_vars['status_meta']->value,'display'=>$_smarty_tpl->tpl_vars['display']->value,'update_controller'=>"addons",'status_target_id'=>"addons_list,header_navbar,header_subnav,addons_counter",'ajax_full_render'=>true), 0);?>
