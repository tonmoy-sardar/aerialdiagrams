<?php /* Smarty version Smarty-3.1.21, created on 2018-12-26 08:07:26
         compiled from "C:\xampp\htdocs\cscart-demo\design\backend\templates\views\categories\components\categories_tree_simple.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18529747745c230c8e8b5dd1-31755327%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '436b08da495925392379f932f664f8502553d66a' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart-demo\\design\\backend\\templates\\views\\categories\\components\\categories_tree_simple.tpl',
      1 => 1543374418,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '18529747745c230c8e8b5dd1-31755327',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c230c8e94a464_46431636',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c230c8e94a464_46431636')) {function content_5c230c8e94a464_46431636($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include 'C:\\xampp\\htdocs\\cscart-demo\\app\\lib\\vendor\\smarty\\smarty\\libs\\plugins\\function.math.php';
if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\\block.hook.php';
?><?php
fn_preload_lang_vars(array('expand_collapse_list','expand_collapse_list','expand_collapse_list','expand_collapse_list','categories','products','expand_sublist_of_items','expand_sublist_of_items','collapse_sublist_of_items','disabled'));
?>
...
" class="cm-item" />
        ...
        <?php }?>
        <td style="padding-left: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_shift']->value, ENT_QUOTES, 'UTF-8');?>
px;">
            <?php if ($_smarty_tpl->tpl_vars['cur_cat']->value['has_children']||$_smarty_tpl->tpl_vars['cur_cat']->value['subcategories']) {?>
                <?php if ($_smarty_tpl->tpl_vars['show_all']->value) {?>
...
" <?php if (!$_smarty_tpl->tpl_vars['cur_cat']->value['has_children']&&!$_smarty_tpl->tpl_vars['cur_cat']->value['subcategories']) {?> style="padding-left: 6px;"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cur_cat']->value['category'], ENT_QUOTES, 'UTF-8');?>
</label>
            <?php }?>
