<?php /* Smarty version Smarty-3.1.21, created on 2018-12-15 09:27:58
         compiled from "C:\xampp\htdocs\cscart-demo\design\backend\templates\views\profiles\update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2533205585c149eeea1bad0-36565866%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6ac82a638461972f431e252b82898446c7b09650' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart-demo\\design\\backend\\templates\\views\\profiles\\update.tpl',
      1 => 1543374418,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2533205585c149eeea1bad0-36565866',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c149eeeadee29_04662531',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c149eeeadee29_04662531')) {function content_5c149eeeadee29_04662531($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\\block.hook.php';
?><?php
fn_preload_lang_vars(array('contact_information','user_profile_info','text_multiprofile_notice','billing_address','shipping_address','shipping_address','usergroup','status','usergroup','status','no_data','allow_api_access','api_key','new_profile','editing_profile','view_all_orders','act_on_behalf','delete','create','notify_user'));
?>
        ...
        <div id="content_api">
            ...
            <div id="api_container" <?php if ($_smarty_tpl->tpl_vars['user_data']->value['api_key']=='') {?>class="hidden"<?php }?>>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="input-large" name="user_data[api_key]" value="<?php if ($_smarty_tpl->tpl_vars['user_data']->value['api_key']) {
