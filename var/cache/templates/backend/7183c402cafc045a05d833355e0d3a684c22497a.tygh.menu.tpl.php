<?php /* Smarty version Smarty-3.1.21, created on 2018-12-15 08:51:45
         compiled from "C:\xampp\htdocs\cscart-demo\design\backend\templates\menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2453931585c1496712ff242-62152012%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7183c402cafc045a05d833355e0d3a684c22497a' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart-demo\\design\\backend\\templates\\menu.tpl',
      1 => 1543374418,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2453931585c1496712ff242-62152012',
  'function' => 
  array (
    'menu_attrs' => 
    array (
  ...
  array (
    'settings' => 0,
    'runtime' => 0,
    'is_current_storefront_closed' => 0,
    'access_key' => 0,
    'attrs' => 0,
    'attr' => 0,
    'value' => 0,
  ...
  'unifunc' => 'content_5c149671420351_77236549',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c149671420351_77236549')) {function content_5c149671420351_77236549($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\\modifier.enum.php';
...
if (!is_callable('smarty_modifier_sizeof')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\\modifier.sizeof.php';
?><?php
fn_preload_lang_vars(array('all_vendors','view_storefront','storefront_url_not_defined','manage_stores','vendor','manage_stores','view_storefront','vendor','manage_vendors','signed_in_as','edit_profile','sign_out','feedback_values','send_feedback','search_tooltip','close','vendor','signed_in_as','edit_profile','sign_out','manage_stores','feedback_values','send_feedback','view_storefront','view_storefront','view_storefront','view_storefront','home','language','currency','go_back','search','more'));
?>
...
<?php if (fn_allowed_for("MULTIVENDOR")) {?>
    <?php $_smarty_tpl->tpl_vars['is_current_storefront_closed'] = new Smarty_variable($_smarty_tpl->tpl_vars['settings']->value['General']['store_mode']===smarty_modifier_enum("StorefrontStatuses::CLOSED"), null, 0);?>
<?php } else { ?>
    <?php $_smarty_tpl->tpl_vars['is_current_storefront_closed'] = new Smarty_variable($_smarty_tpl->tpl_vars['runtime']->value['company_data']['company_id']&&$_smarty_tpl->tpl_vars['settings']->value['General']['store_mode']===smarty_modifier_enum("StorefrontStatuses::CLOSED"), null, 0);?>
<?php }?>

<?php if ($_smarty_tpl->tpl_vars['is_current_storefront_closed']->value) {?>
    <?php $_smarty_tpl->tpl_vars['access_key'] = new Smarty_variable($_smarty_tpl->tpl_vars['settings']->value['General']['store_access_key'], null, 0);?>
    <?php $_smarty_tpl->tpl_vars['store_access_key'] = new Smarty_variable("store_access_key=".((string)$_smarty_tpl->tpl_vars['access_key']->value), null, 0);?>
<?php }?>
...
">
    ...
    <div class="navbar navbar-inverse mobile-hidden" id="header_navbar">
        <div class="navbar-inner<?php if ($_smarty_tpl->tpl_vars['is_current_storefront_closed']->value||$_smarty_tpl->tpl_vars['runtime']->value['are_all_storefronts_closed']) {?> navbar-inner--disabled<?php }?>">
        ...
        <?php if (fn_allowed_for("ULTIMATE")) {?>
            <?php if ($_smarty_tpl->tpl_vars['is_current_storefront_closed']->value||$_smarty_tpl->tpl_vars['runtime']->value['are_all_storefronts_closed']) {?>
            ...
            <div class="nav-ult">
                ...
                <?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_data']['storefront']) {?>
                    <a href="<?php echo htmlspecialchars(fn_url(fn_link_attach("?company_id=".((string)$_smarty_tpl->tpl_vars['runtime']->value['company_data']['company_id']),$_smarty_tpl->tpl_vars['store_access_key']->value),"C"), ENT_QUOTES, 'UTF-8');?>
...
...</a></li>
        ...
        <?php if (fn_allowed_for("MULTIVENDOR")&&!$_smarty_tpl->tpl_vars['runtime']->value['simple_ultimate']) {?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['is_current_storefront_closed']->value) {?>
                <?php $_smarty_tpl->tpl_vars['storefront_status_icon'] = new Smarty_variable("icon-lock", null, 0);?>
            <?php } else { ?>
                <?php $_smarty_tpl->tpl_vars['storefront_status_icon'] = new Smarty_variable(false, null, 0);?>
            <?php }?>

            <ul class="nav">
                <li class="nav-company">
                    <?php $_smarty_tpl->tpl_vars['storefront_url'] = new Smarty_variable(fn_url($_smarty_tpl->tpl_vars['config']->value['http_location']), null, 0);?>
                    <?php if ($_smarty_tpl->tpl_vars['store_access_key']->value) {?>
                        <?php $_smarty_tpl->tpl_vars['storefront_url'] = new Smarty_variable(fn_link_attach($_smarty_tpl->tpl_vars['storefront_url']->value,$_smarty_tpl->tpl_vars['store_access_key']->value), null, 0);?>
                    <?php }?>
                    <a href="<?php echo htmlspecialchars(htmlspecialchars($_smarty_tpl->tpl_vars['storefront_url']->value, ENT_QUOTES, 'UTF-8', true), ENT_QUOTES, 'UTF-8');?>
" target="_blank" class="brand" title="<?php echo $_smarty_tpl->__("view_storefront");?>
">
                        <i class="icon-shopping-cart icon-white"></i>
                    </a>
...
" class="brand company-name"><?php echo htmlspecialchars(smarty_modifier_truncate($_smarty_tpl->tpl_vars['settings']->value['Company']['company_name'],60,"...",true), ENT_QUOTES, 'UTF-8');?>
                    ...
                    <a href="<?php echo htmlspecialchars(fn_url("settings.manage?section_id=General&highlight=store_mode,store_access_key"), ENT_QUOTES, 'UTF-8');?>
" class="brand">
...
...</a></li>
            ...
            <?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_data']['storefront']) {?>
                <li class="dropdown">
                    <a  href="<?php echo htmlspecialchars(fn_link_attach(fn_url("?company_id=".((string)$_smarty_tpl->tpl_vars['runtime']->value['company_data']['company_id']),"C"),$_smarty_tpl->tpl_vars['store_access_key']->value), ENT_QUOTES, 'UTF-8');?>
"
                        target="_blank"
...
"
            ...
            <?php } else { ?>
                <?php if (fn_allowed_for("MULTIVENDOR")) {?>
                    <li class="dropdown">
                        <a  href="<?php echo htmlspecialchars(fn_link_attach(fn_url('',"C"),$_smarty_tpl->tpl_vars['store_access_key']->value), ENT_QUOTES, 'UTF-8');?>
"
                            target="_blank"
                            title="<?php echo $_smarty_tpl->__("view_storefront");?>
"
