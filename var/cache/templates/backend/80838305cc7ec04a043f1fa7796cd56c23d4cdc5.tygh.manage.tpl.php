<?php /* Smarty version Smarty-3.1.21, created on 2018-12-15 09:02:53
         compiled from "C:\xampp\htdocs\cscart-demo\design\backend\templates\views\orders\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10483036455c14990d6e88d6-76541210%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '80838305cc7ec04a043f1fa7796cd56c23d4cdc5' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart-demo\\design\\backend\\templates\\views\\orders\\manage.tpl',
      1 => 1543374418,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '10483036455c14990d6e88d6-76541210',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c14990d8099b2_03492126',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c14990d8099b2_03492126')) {function content_5c14990d8099b2_03492126($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\\block.hook.php';
if (!is_callable('smarty_modifier_date_format')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\\modifier.date_format.php';
?><?php
fn_preload_lang_vars(array('text_admin_new_orders','incompleted_orders','orders','id','status','date','customer','phone','total','id','order','invoice','credit_memo','status','date','customer','phone','tools','view','edit','copy','delete','total','no_data','for_this_page_orders','gross_total','totally_paid','for_all_found_orders','gross_total','totally_paid','add_order','view_all_orders','incompleted_orders','bulk_print_invoice','bulk_print_pdf','bulk_print_packing_slip','view_purchased_products','export_selected'));
?>
...
"<?php }?>><bdi><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['phone'], ENT_QUOTES, 'UTF-8');?>
</bdi></td>
...
<?php $_tmp5=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'href'=>"orders.manage",'text'=>$_tmp5));?>
</li>
    <?php } else { ?>
        <li><?php ob_start();?><?php echo $_smarty_tpl->__("incompleted_orders");?>
<?php $_tmp6=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'href'=>"orders.manage?skip_view=Y&status=".((string)@constant('STATUS_INCOMPLETED_ORDER')),'text'=>$_tmp6,'form'=>"orders_list_form"));?>
</li>
    <?php }?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
...
<?php $_tmp7=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>$_tmp7,'dispatch'=>"dispatch[orders.bulk_print]",'form'=>"orders_list_form",'class'=>"cm-new-window"));?>
</li>
            <li><?php ob_start();?><?php echo $_smarty_tpl->__("bulk_print_pdf");?>
<?php $_tmp8=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>$_tmp8,'dispatch'=>"dispatch[orders.bulk_print..pdf]",'form'=>"orders_list_form"));?>
</li>
...
<?php $_tmp10=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>$_tmp10,'dispatch'=>"dispatch[orders.products_range]",'form'=>"orders_list_form"));?>
</li>

            <li class="divider"></li>
            <li class="mobile-hide"><?php ob_start();?><?php echo $_smarty_tpl->__("export_selected");?>
<?php $_tmp11=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>$_tmp11,'dispatch'=>"dispatch[orders.export_range]",'form'=>"orders_list_form"));?>
</li>
