<?php /* Smarty version Smarty-3.1.21, created on 2018-12-20 13:00:23
         compiled from "C:\xampp\htdocs\cscart-demo\design\backend\templates\views\product_options\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21267200505c1b68372ea6f0-40430389%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '90c320b79abb7c5a2861d2e4a1035379fda783a8' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart-demo\\design\\backend\\templates\\views\\product_options\\manage.tpl',
      1 => 1543374418,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '21267200505c1b68372ea6f0-40430389',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c1b68373c1469_53733758',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c1b68373c1469_53733758')) {function content_5c1b68373c1469_53733758($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\\function.script.php';
...
?><?php
fn_preload_lang_vars(array('new_option','add_option','new_option','add_option','apply_to_products','name','internal_option_name','internal_option_name_tooltip','status','global','edit','view','view','editing_option','name','internal_option_name','status','no_data','options'));
?>
...
" data-ca-target-id="pagination_contents"><?php echo $_smarty_tpl->__("internal_option_name");?>
</a><?php ob_start();?><?php echo $_smarty_tpl->__("internal_option_name_tooltip");?>
...
if ($_smarty_tpl->tpl_vars['search']->value['sort_by']=="additional_option_name") {
echo $_smarty_tpl->tpl_vars['sort_sign']->value;
}?>
                            </th>
                            <th></th>
                            <th></th>
                            <th class="pull-right"><?php echo $_smarty_tpl->__("status");?>
</th>
                        </tr>
                        </thead>
                    <?php }?>
...
$_tmp2=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["details"] = new Smarty_variable("(".$_tmp2.")", null, 0);?>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['po']->value['internal_option_name']) {?>
                                <?php $_smarty_tpl->tpl_vars['option_name'] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['po']->value['option_name'])." / ".((string)$_smarty_tpl->tpl_vars['po']->value['internal_option_name']), null, 0);?>
                            <?php }?>
...
echo $_smarty_tpl->__("internal_option_name");
$_tmp5=ob_get_clean();?><?php ob_start();
echo $_smarty_tpl->__("status");
$_tmp6=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/object_group.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('no_table'=>true,'id'=>$_smarty_tpl->tpl_vars['po']->value['option_id'],'id_prefix'=>"_product_option_",'details'=>$_smarty_tpl->tpl_vars['details']->value,'text'=>$_smarty_tpl->tpl_vars['option_name']->value,'hide_for_vendor'=>$_smarty_tpl->tpl_vars['hide_for_vendor']->value,'status'=>$_smarty_tpl->tpl_vars['status']->value,'table'=>"product_options",'object_id_name'=>"option_id",'href'=>"product_options.update?option_id=".((string)$_smarty_tpl->tpl_vars['po']->value['option_id']).((string)$_smarty_tpl->tpl_vars['query_product_id']->value),'href_delete'=>$_smarty_tpl->tpl_vars['href_delete']->value,'delete_target_id'=>$_smarty_tpl->tpl_vars['delete_target_id']->value,'header_text'=>$_tmp3.": ".((string)$_smarty_tpl->tpl_vars['po']->value['option_name']),'skip_delete'=>!$_smarty_tpl->tpl_vars['allow_save']->value,'additional_class'=>$_smarty_tpl->tpl_vars['additional_class']->value,'prefix'=>"product_options",'link_text'=>$_smarty_tpl->tpl_vars['link_text']->value,'non_editable'=>$_smarty_tpl->tpl_vars['non_editable']->value,'company_object'=>$_smarty_tpl->tpl_vars['po']->value,'href_desc_row_hint'=>$_tmp4." / ".$_tmp5,'status_row_hint'=>$_tmp6), 0);?>
