<?php /* Smarty version Smarty-3.1.21, created on 2018-12-15 09:02:53
         compiled from "C:\xampp\htdocs\cscart-demo\design\backend\templates\views\orders\components\orders_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7818181255c14990db97c15-77630357%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f41612f5cf4a5d6875f602e1515fc6118417cef9' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart-demo\\design\\backend\\templates\\views\\orders\\components\\orders_search_form.tpl',
      1 => 1543374418,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '7818181255c14990db97c15-77630357',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c14990dc0cf23_48221766',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c14990dc0cf23_48221766')) {function content_5c14990dc0cf23_48221766($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\\block.hook.php';
...
?><?php
fn_preload_lang_vars(array('search','customer','email','phone','total','manager','period','order_status','tax_exempt','yes','no','order_id','company','has_credit_memo','credit_memo_id','has_invoice','invoice_id','new_orders','shipping','payment_methods','ordered_products'));
?>
...
<?php if ($_smarty_tpl->tpl_vars['incompleted_view']->value) {?>
    <input type="hidden" name="status" value="<?php echo htmlspecialchars(@constant('STATUS_INCOMPLETED_ORDER'), ENT_QUOTES, 'UTF-8');?>
" />
<?php } else { ?>
<div class="control-group">
...
<div class="group">
    <div class="control-group">
        <label class="checkbox" for="a_uid"><input type="checkbox" name="admin_user_id" id="a_uid" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['auth']->value['user_id'], ENT_QUOTES, 'UTF-8');?>
" <?php if ($_smarty_tpl->tpl_vars['search']->value['admin_user_id']) {?>checked="checked"<?php }?> /><?php echo $_smarty_tpl->__("new_orders");?>
</label>
    </div>
</div>
<div class="group">
