<?php /* Smarty version Smarty-3.1.21, created on 2018-12-15 08:59:12
         compiled from "C:\xampp\htdocs\cscart-demo\design\themes\responsive\templates\views\checkout\components\checkout_login.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20221270365c1498303717c9-85489737%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f5d1e26a0edd9b6abea462853abaed3064c5c0c5' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart-demo\\design\\themes\\responsive\\templates\\views\\checkout\\components\\checkout_login.tpl',
      1 => 1544853072,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '20221270365c1498303717c9-85489737',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c149830425274_75802414',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c149830425274_75802414')) {function content_5c149830425274_75802414($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart-demo/app/functions/smarty_plugins\\block.hook.php';
        ...
        <?php $_smarty_tpl->_capture_stack[0][] = array("register", null, null); ob_start(); ?>
            <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['approve_user_profiles']!="Y") {?>
                <div id="register_checkout" class="ty-checkout-buttons<?php if ($_smarty_tpl->tpl_vars['settings']->value['Checkout']['sign_in_default_action']!="register") {?> cm-noscript<?php }?>">
                    <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_onclick'=>"fn_switch_checkout_type();Tygh."."$"."('.cm-focus').focus();",'but_meta'=>"ty-btn__primary",'but_text'=>$_smarty_tpl->__("register")), 0);?>
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
        ...
        <?php $_smarty_tpl->_capture_stack[0][] = array("anonymous", null, null); ob_start(); ?>
            <?php if ($_smarty_tpl->tpl_vars['settings']->value['Checkout']['disable_anonymous_checkout']!="Y") {?>
                <div id="anonymous_checkout" class="<?php if ($_smarty_tpl->tpl_vars['settings']->value['Checkout']['sign_in_default_action']=="register"&&$_smarty_tpl->tpl_vars['settings']->value['General']['approve_user_profiles']!="Y") {?> cm-noscript<?php }?>">
...
" method="post">
                        ...
                        <?php if (!$_smarty_tpl->tpl_vars['contact_fields_filled']->value) {?>
                            <div class="ty-control-group ty-anonymous_checkout__field">
                                <label for="guest_email" class="cm-required cm-email"><?php echo $_smarty_tpl->__("email");?>
</label>
                                <input type="text" id="guest_email" name="user_data[email]" size="32" value="" class="ty-input-text" />
                            </div>
                        <?php }?>

                        <?php echo $_smarty_tpl->getSubTemplate ("common/image_verification.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('option'=>"checkout"), 0);?>


                        <div class="ty-checkout-buttons">
                            <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_meta'=>"ty-btn__primary",'but_name'=>"dispatch[checkout.customer_info]",'but_text'=>$_smarty_tpl->__("checkout_as_guest")), 0);?>
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
        ...
        <div class="ty-checkout__register-content">
            <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['approve_user_profiles']!="Y"||$_smarty_tpl->tpl_vars['settings']->value['Checkout']['disable_anonymous_checkout']!="Y") {?>
                <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>$_smarty_tpl->__("new_customer")), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                ...
                <?php if ($_smarty_tpl->tpl_vars['settings']->value['Checkout']['disable_anonymous_checkout']!="Y") {?>
                    <li class="ty-checkout__register-methods-item">
                        <input class="ty-checkout__register-methods-radio" type="radio" id="checkout_type_guest" name="checkout_type" value=""<?php if ($_smarty_tpl->tpl_vars['settings']->value['Checkout']['sign_in_default_action']!="register"||$_smarty_tpl->tpl_vars['settings']->value['General']['approve_user_profiles']=="Y") {?> checked="checked"<?php }?> onclick="fn_show_checkout_buttons('guest')" />
